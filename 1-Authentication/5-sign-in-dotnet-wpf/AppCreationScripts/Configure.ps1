...
Function ConfigureApplications
{
   ...
   Write-Host "Creating the AAD application (ciam-wpf-sign-in)"
   # create the application 
   $clientAadApplication = New-MgApplication -DisplayName "ciam-wpf-sign-in" `
                                                      -PublicClient `
                                                      @{ `
    ...
    $replyUrlsForApp = "https://login.microsoftonline.com/common/oauth2/nativeclient"
    Update-MgApplication -ApplicationId $currentAppObjectId -PublicClient @{RedirectUris=$replyUrlsForApp}
    $tenantName = (Get-MgApplication -ApplicationId $currentAppObjectId).PublisherDomain
    #Update-MgApplication -ApplicationId $currentAppObjectId -IdentifierUris @("https://$tenantName/ciam-wpf-sign-in")
    ...
    Add-Content -Value "<tr><td>client</td><td>$currentAppId</td><td><a href='$clientPortalUrl'>ciam-wpf-sign-in</a></td></tr>" -Path createdApps.html
