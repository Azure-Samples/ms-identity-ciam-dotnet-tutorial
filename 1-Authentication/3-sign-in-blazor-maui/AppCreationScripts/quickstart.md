...
description: Learn how to run .NET MAUI Blazor Hybrid app to sign in and sign out users with Microsoft Entra External ID for customers tenant
...
ms.topic: conceptual
ms.date: 12/08/2023
#Customer intent: As a dev, devops, I want to learn how to run .NET MAUI Blazor Hybrid app to sign in and sign out users with Microsoft Entra External ID for customers tenant
---

# Portal quickstart for NET Multi-platform App UI

> In this quickstart, you download and run a code sample that demonstrates how .NET MAUI Blazor Hybrid can sign in users with Microsoft Entra External ID for customers.
>
...
> 2. Open the solution in Visual Studio (/ms-identity-ciam-dotnet-tutorial/1-Authentication/3-sign-in-blazor-maui)
