...
Function ConfigureApplications
{
   ...
   $clientAadApplication = New-MgApplication -DisplayName "call-todo-api-blazor" `
    ...
    $dictionary = @{ "Instance" = "https://$domainPrefix.ciamlogin.com"; "TenantId" = $tenantId;"ClientId" = $clientAadApplication.AppId;"ClientSecret" = $pwdCredential.SecretText;"Scopes" = "api://$($serviceAadApplication.AppId)/ToDoList.Read api://$($serviceAadApplication.AppId)/ToDoList.ReadWrite";"BaseAddress" = $serviceAadApplication.Web.HomePageUrl };
