...
Function ConfigureApplications
{
   ...
   $clientAadApplication = New-MgApplication -DisplayName "ciam-blazor-webapp" `
    ...
    $dictionary = @{ "Enter_the_Tenant_Id_Here" = $tenantId;"Enter_the_Application_Id_Here" = $serviceAadApplication.AppId;"Enter_the_Tenant_Subdomain_Here" = $tenantName.Split(".onmicrosoft.com")[0] };
